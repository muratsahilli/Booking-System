...
namespace DAL.Migrations
{
    ...
    [Migration("20220817181744_migration_one")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AramaAramaTipi", b =>
                {
                    b.Property<int>("AramaTipiArama_tipi_id")
                        .HasColumnType("integer");

                    b.Property<int>("AramalarArama_id")
                        .HasColumnType("integer");

                    b.HasKey("AramaTipiArama_tipi_id", "AramalarArama_id");

                    b.HasIndex("AramalarArama_id");

                    b.ToTable("AramaAramaTipi");
                });

            modelBuilder.Entity("AramaArayanTipi", b =>
                {
                    b.Property<int>("AramalarArama_id")
                        .HasColumnType("integer");

                    b.Property<int>("ArayanTipiArayan_tipi_id")
                        .HasColumnType("integer");

                    b.HasKey("AramalarArama_id", "ArayanTipiArayan_tipi_id");

                    b.HasIndex("ArayanTipiArayan_tipi_id");

                    b.ToTable("AramaArayanTipi");
                });
            ...
            modelBuilder.Entity("AramaAramaTipi", b =>
                {
                    b.HasOne("Entity.Concrete.AramaTipi", null)
                        .WithMany()
                        .HasForeignKey("AramaTipiArama_tipi_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity.Concrete.Arama", null)
                        .WithMany()
                        .HasForeignKey("AramalarArama_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AramaArayanTipi", b =>
                {
                    ...
                    b.HasOne("Entity.Concrete.ArayanTipi", null)
                        .WithMany()
                        .HasForeignKey("ArayanTipiArayan_tipi_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Entity.Concrete.AppUser", b =>
                {
                    b.HasOne("Entity.Concrete.Arama", null)
                        .WithMany("Aranan")
                        .HasForeignKey("Arama_id");

                    b.HasOne("Entity.Concrete.Arama", null)
                        .WithMany("Kaydeden")
                        .HasForeignKey("Arama_id1");
                });
