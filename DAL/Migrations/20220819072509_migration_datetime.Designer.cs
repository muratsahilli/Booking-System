...
namespace DAL.Migrations
{
    ...
    [Migration("20220819072509_migration_datetime")]
    partial class migration_datetime
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.Concrete.Arama", b =>
                {
                    ...
                    b.Property<DateTime>("Aranma_Saati")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Entity.Concrete.Randevular", b =>
                {
                    b.HasOne("Entity.Concrete.KullanıcıRandevu", "KullanıcıRandevu")
                        .WithMany("Randevu")
                        .HasForeignKey("KullanıcıRandevuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity.Concrete.RandevuDurumu", "Randevu_Durumu")
                        .WithMany("Appoints")
